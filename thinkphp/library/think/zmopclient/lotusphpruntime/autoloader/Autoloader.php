<?php
namespace think\zmopclient\lotusphpruntime\autoloader;
use think\zmopclient\lotusphpruntime;
use think\zmopclient\lotusphpruntime\Store;
use think\zmopclient\lotusphpruntime\LtStoreMemory;
use think\zmopclient\lotusphpruntime\LtStoreFile;
class Autoloader
{
	public $conf = array(
	/**
