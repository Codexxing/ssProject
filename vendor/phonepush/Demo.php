<?php
include(dirname(__FILE__) . '/' . 'notification/android/AndroidBroadcast.php');
include(dirname(__FILE__) . '/' . 'notification/android/AndroidFilecast.php');
include(dirname(__FILE__) . '/' . 'notification/android/AndroidGroupcast.php');
include(dirname(__FILE__) . '/' . 'notification/android/AndroidUnicast.php');
include(dirname(__FILE__) . '/' . 'notification/android/AndroidCustomizedcast.php');
include(dirname(__FILE__) . '/' . 'notification/ios/IOSBroadcast.php');
include(dirname(__FILE__) . '/' . 'notification/ios/IOSFilecast.php');
include(dirname(__FILE__) . '/' . 'notification/ios/IOSGroupcast.php');
include(dirname(__FILE__) . '/' . 'notification/ios/IOSUnicast.php');
include(dirname(__FILE__) . '/' . 'notification/ios/IOSCustomizedcast.php');
...
//群组形式   向满足特定条件的设备集合发送消息，例如: “特定版本”、”特定地域”等
